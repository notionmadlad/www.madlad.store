    ...
    >
      ...
      >
        <div
          ...
          className="absolute left-1/2 p-4 top-1/2 flex justify-start items-start rounded-2xl bg-card border border-border transition duration-700 overflow-hidden"
        >
      ...
      <div className=" w-full h-full -mt-7 flex-none  inset-0">
        <div className="absolute top-0 inset-x-0  flex justify-center">
          <a
            href={href}
            target={"_blank"}
            className="relative flex space-x-2 items-center z-10 rounded-md bg-card py-0.5 px-4 ring-1 ring-white/10 "
          >
            <span className="relative z-20 text-white text-center text-[16px] font-bold inline-block py-0.5">
              {title}
            </span>
          </a>
        </div>
